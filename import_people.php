...
echo    '<div id="main-container">
        ...
        <li><img style="width: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; border-radius: 50%;" src="img/Prospects 3.png"  /> <a href="people.php">People</a></li>
        <li class="active">IMPORT People</li>
        </ul>
        </div>
        ...
        <form class="no-margin" id="formValidate2" data-validate="parsley" method="post" action="get_import_people.php" name="client_record" enctype="multipart/form-data" novalidate>
        <div class="panel-heading" style="color: rgb(51, 51, 51); font-size: 22px; font-weight: 700; margin-left: 15px;">Import People</div>
...
echo    '</div>
        ...
        &nbsp;&nbsp;&nbsp;<a href="Sample data format-p.xlsx"><img src="templates-for-excel-pro-icon.png" width="30px" height="30px"></a>
        <br/> <br/>
