...
$people=get_records_sql("select * from pia_people where id='".$_GET['id']."' order by date_time desc"); 
$i=1;
foreach($people AS $ppl){
    //var_dump($ppl);
		...
		/**
        $ph=$a1[0];
		$effectivedate= $ppl->date_time; 
		$effectivedate = str_replace('-', '/', $effectivedate);
		$effectivedate = date('d/m/Y', strtotime($effectivedate)); 
		//echo $effectivedate;
		$Questions= $ppl->Questions;
        **/
                
echo    '<form class="no-margin" id="formValidate2" data-validate="parsley" method="post" action="update_people.php" name="client_record" enctype="multipart/form-data" novalidate>
        <div class="panel-heading"><i class="fa fa-user fa-lg"></i>Edit People<span><br />
        <br />
        <a href="people.php">Cancel</a></span>
        </div>
...
echo    '</div>
        ...
        <input type="text" placeholder="Person ID" class="form-control input-sm parsley-validated" readonly value="'.$ppl->people_id.'" data-required="true" name="people_id">
        </div>
        </div>
        <!-- /.col -->
        ...
        <input type="text" placeholder="Phone" class="form-control input-sm parsley-validated " value="'.$ph[0].'" data-required="true" name="phone">
        ...
        <input type="text" placeholder="First name" class="form-control input-sm parsley-validated" value="'.$ppl->firstname.'" data-required="true" name="firstname">
        </div>
        </div>
        <!-- /.col -->
        ...
        <input type="text" placeholder="Address" value="'.$ppl->address.'" class="form-control input-sm parsley-validated " data-required="true" name="Address">
        </div>
        </div>
        <!-- /.col --> 
        </div>
        ...
        <input type="text" placeholder="Last name" value="'.$ppl->lastname.'" class="form-control input-sm parsley-validated " data-required="true" name="lastname">
        </div>
        </div>
        <!-- /.col -->
        ...
        <input type="text" placeholder="City" value="'.$ppl->city.'" class="form-control input-sm parsley-validated " data-required="true" name="City">
        </div>
        </div>
        <!-- /.col --> 
        </div>
        ...
        <input type="email" placeholder="Email" value="'.$ppl->email.'" class="form-control input-sm parsley-validated " data-required="true" name="email">
        ...
        <div class="input-group">
        <input type="text" placeholder="Zip/postal" class="form-control input-sm parsley-validated " value="'.$ppl->zip.'" data-required="true" name="zip">
		...
		<option value="'.$ppl->Prospect_Status.'">'.$ppl->Prospect_Status.'</option>
        ...
        <input type="text" class="tag-demo1"  id="tags1455191267153" style="display: none;" value="'.$ppl->tags.'" name="tags">
